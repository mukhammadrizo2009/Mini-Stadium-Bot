...
def run_bot() -> None:
    ...
    register_conversion_handler = ConversationHandler(
        entry_points=[MessageHandler(Filters.text("Ro'yhatdan o'tish") , handlers.ask_name)],
        states={
    ...
    booking_stadion_handler = ConversationHandler(
    ...
    dispatcher.add_handler(booking_stadion_handler)
